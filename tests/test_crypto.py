from qzcli.client.crypto import encrypt_password


def test_encrypt_password_preserves_leading_zero():
...
def test_idempotent_on_already_encrypted():
    once = encrypt_password("super-secret-pw")
    assert encrypt_password(once) == once
